...
library(FasterCoordinatesCleaner) # Replace with your actual package name if different
library(microbenchmark)
library(ggplot2)
library(dplyr)

# Load the sample DataFrame with relevant columns
input_file_path <- "/Users/njord888/Downloads/gbif_germany (1).rds"  # Ensure path is correct
